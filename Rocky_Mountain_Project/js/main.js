   ...
   opacity: 0.6})
    ...
    var romoCentersStyle = new carto.style.CartoCSS('#layer {marker-width:16; marker-fill: #EE4D5A; marker-line-color: #FFFFFF}'; marker-file: url("/Rocky_Mountain_Project/lib/images/orange_house.png);
